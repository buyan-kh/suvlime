// Suvlime data — fictional clinics, fictional testimonials, plausible research numbers.
// Until Supabase is wired, this is the source of truth for the homepage.

export type CategoryId = "glp1" | "peptides" | "ed" | "trt" | "sleep";
